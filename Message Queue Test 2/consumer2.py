...
# class Consumer:
#     def __init__(self, partition_ids=[1], host='192.168.151.51', base_port=12346):
...
#     consumer = Consumer(partition_ids=[1])
#     consumer.process()
...
#                             )
#                             sock.sendall(pickle.dumps(confirm_msg))
#                         else:
#                             print(f"Consumer Partition {partition_id} disconnected by Broker")
#                             self.sockets[partition_id] = None
#                     except socket.timeout:
...
class Consumer:
    def __init__(self, partition_ids=[1], host='192.168.107.51', base_port=12346):
        self.partition_ids = partition_ids
        self.host = host
        self.base_port = base_port
        self.sockets = {}
