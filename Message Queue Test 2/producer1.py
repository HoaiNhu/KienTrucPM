...
# #     producer = Producer(producer_id="P1")
# #     messages = [
...
# class Producer:
#     def __init__(self, producer_id, host='192.168.151.51', port=12345, confirm_port=12348):
#         self.producer_id = producer_id
#         self.host = host
#         self.port = port
#         self.confirm_port = confirm_port
#         self.executor = ThreadPoolExecutor(max_workers=10)  # Thêm ThreadPoolExecutor
#         # Khởi động server nhận confirm
...
#         try:
#             with client_socket:
#                 client_socket.settimeout(5)  # Thêm timeout để tránh treo
...
class Producer:
    def __init__(self, producer_id, host='192.168.107.51', port=12345, confirm_port=12348):
        self.producer_id = producer_id
        self.host = host
        self.port = port
        self.confirm_port = confirm_port
